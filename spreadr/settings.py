...
DEFAULT_READ_FACTOR = 1.0
DEFAULT_WRITE_FACTOR = 5.0
DEFAULT_MIN_TOKENS = 10
DEFAULT_PAUSE_PERIOD = 10
DEFAULT_JABBERWOCKY_MODE = False
DEFAULT_HEARTBEAT = 10
DEFAULT_HEARTBEAT_MARGIN = 10
...
HUNSPELL = {
    'english': [{
        ...
        'DIC': os.path.join(BASE_DIR, 'spell', 'en_US.dic'),
        'AFF': os.path.join(BASE_DIR, 'spell', 'en_US.aff'),
    }]
}
