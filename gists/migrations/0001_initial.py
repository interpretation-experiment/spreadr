...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='sentence',
            name='tree_as_root',
            field=models.OneToOneField(related_name='root', to='gists.Tree', null=True),
            preserve_default=True,
        ),
    ]
